...
for MIGRATION in 003_service_deposits.sql 004_paypal_deposit_columns.sql 005_merch_orders.sql 006_newsletter_subscribers.sql 007_auth_tables.sql 008_account_files.sql; do
